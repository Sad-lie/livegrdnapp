...
config :live_grdn_app,
  ecto_repos: [LiveGrdnApp.Repo],
...
config :live_grdn_app, LiveGrdnAppWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: LiveGrdnAppWeb.ErrorHTML, json: LiveGrdnAppWeb.ErrorJSON],
    layout: false
  ],
...
config :live_grdn_app, LiveGrdnApp.Mailer, adapter: Swoosh.Adapters.Local
